...
<body class="hold-transition <?php echo $name?> sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      <?php
        require 'parts/styles/claims/doctor/sidenav.php';
      ?>
    </aside>
    ...
    <div class="content-wrapper">
      <section name="menu" class="content">
        <?php
          require 'parts/styles/claims/doctor/header.php';
          require 'parts/styles/claims/doctor/navbar.php';
          require 'parts/datagrid/claims/doctor/datagrid.php';
        ?>
      </section>
    </div>
