...
<body class="hold-transition <?php echo $name?> sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      <?php
        require 'parts/styles/report/collection/sidenav.php';
      ?>
    </aside>
    ...
    <div class="content-wrapper">
      <section name="menu" class="content">
        <?php
          require 'parts/styles/report/collection/header.php';
          require 'parts/styles/report/collection/navbar.php';
          require 'parts/datagrid/report/collection/datagrid.php';
        ?>
      </section>
    </div>
