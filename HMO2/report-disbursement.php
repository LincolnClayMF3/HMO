...
<body class="hold-transition <?php echo $name?> sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      <?php
        require 'parts/styles/report/disbursement/sidenav.php';
      ?>
    </aside>
    ...
    <div class="content-wrapper">
      <section name="menu" class="content">
        <?php
          require 'parts/styles/report/disbursement/header.php';
          require 'parts/styles/report/disbursement/navbar.php';
          require 'parts/datagrid/report/disbursement/datagrid.php';
        ?>
      </section>
    </div>
