...
<li class="treeview active">
  ...
  <ul class="treeview-menu">
    ...
    <li class="active"><a> Additional Services</a></li>
  </ul>
</li>
...
<li class="treeview">
  <a href="#">
    ...
    <ul class="treeview-menu">
      ...
      <li><a href="report-collection.php"> Collection</a></li>
    ...
    <li class="treeview">
      <a href="#">
        <i class="fa fa-link"></i>
           <img src="dist/img/utility.png" height="45" width="45">&nbsp;&nbsp;Utilities
        <i class="fa fa-angle-left pull-right"></i></a>
        <ul class="treeview-menu">
          <li><a href="utilities-employee.php"> Employee</a></li>
          <li><a href="utilities-skins.php"> System Setting</a></li>
        </ul>
    </li>
  </ul>
</section>
