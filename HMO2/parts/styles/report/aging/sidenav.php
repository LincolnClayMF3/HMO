...
<li class="treeview">
  <a href="#">
    <i class="fa fa-link"></i>
       <img src="dist/img/query.png" height="45" width="45">&nbsp;&nbsp;Query <b class="caret"></b>
     <i class="fa fa-angle-left pull-right"></i></a>
     <ul class="treeview-menu">
...
<li class="treeview active">
  <a href="report.php">
    <i class="fa fa-link"></i>
       <img src="dist/img/report.png" height="45" width="45">&nbsp;&nbsp;Report <b class="caret"></b>
    <i class="fa fa-angle-left pull-right"></i></a>
    <ul class="treeview-menu">
    ...
    <li class="treeview">
      <a href="#">
        <i class="fa fa-link"></i>
           <img src="dist/img/utility.png" height="45" width="45">&nbsp;&nbsp;Utility
        <i class="fa fa-angle-left pull-right"></i></a>
        <ul class="treeview-menu">
          <li><a href="utilities-employee.php"> Employee</a></li>
          <li><a href="utilities-settings.php"> System Settings</a></li>
          <li><a href="utilities-skins.php"> Skins</a></li>
        </ul>
    </li>
  </ul>
</section>
