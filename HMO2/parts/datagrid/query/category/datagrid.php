    ...
    <tbody>
      ...
      if($class == "None"){
        ...
        while ($row = mysqli_fetch_array($fetchCategory)) {
          ...
          $categoryClass = $row['specification'];
      ...
      if(isset($_POST['btnSearch'])){
        ...
        if($class == "Year"){
          ...
          $fetchCategory = mysqli_query($con, "SELECT * FROM tblcategory WHERE specification = 'Per Year'
        ...
        elseif ($class == "Illness"){
          ...
          $fetchCategory = mysqli_query($con, "SELECT * FROM tblcategory WHERE specification = 'Per Illness'
                           AND status = 'Active' ORDER By categoryType ASC");
        ...
        elseif ($class == "IllYear"){
          ...
          $fetchCategory = mysqli_query($con, "SELECT * FROM tblcategory WHERE specification = 'Per Year Per Illness'
                           AND status = 'Active' ORDER By categoryType ASC");
