...
$result = mysqli_query($con,"SELECT * FROM tblcompanymaintenance");
  while ($row = mysqli_fetch_array($result)) {
    ...
    $name = $row['companyMainName'];
     ...
     ?>
  <div class="modal fade modal-danger" id="terminateCompany<?php echo $id ?>"  style="z-index:1051" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content" style="margin-top: 10em; margin-left: 3em">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title">Terminate Company</h4>
        </div>
...
if(isset($_POST['btnDelete'])){
  ...
  require 'parts/php/post/contract/company/btnDelete.php';
