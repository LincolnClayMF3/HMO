...
$result = mysqli_query($con,"SELECT * FROM tblhospitalmaintenance");
  while ($row = mysqli_fetch_array($result)) {
    ...
    $id = $row['hospitalMainID'];
     ?>
  <div class="modal fade modal-danger" id="terminateHospital<?php echo $id ?>" style="z-index:1051" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content" style="margin-top: 10em; margin-left: 3em">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title">Terminate Hospital</h4>
        </div>
        <div class="modal-body">
          <form role="form" method="post">
          <p>Do You Want To Terminate <?php echo $name ?> ?</p>
        </div>
...
if(isset($_POST['btnDelete'])){
  ...
  require 'parts/php/post/contract/hospital/btnDelete.php';
