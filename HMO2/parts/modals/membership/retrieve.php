...
$result = mysqli_query($con,"SELECT * FROM tblmembershiptype");
  ...
  <div class="modal fade modal-warning" id="retrieveMembership<?php echo $row['membershipID']; ?>" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content" style="margin-top: 10em; margin-left: 3em">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title">Retrieve Membership Type</h4>
        </div>
        <div class="modal-body">
          <form role="form" method="post">
          <p>Do You Want To Retrieve <?php echo $row['membershipName']?> ?</p>
        </div>
...
if(isset($_POST['btnRetrieve'])){
  ...
  require 'parts/php/post/membership/btnRetrieve.php';
