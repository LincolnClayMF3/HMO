<div class="modal fade" id="newAdditional" role="dialog" style="width: 100%" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content" style="margin-top: 3em; margin-left: 3em">
      ...
      <div class="modal-body">
        <form class="additionalform" role="form" method="post" autocomplete="off" onsubmit="return additionalvalthis(this);">
          <div class="form-group col-xs-6">
            <label><span class="glyphicon glyphicon-asterisk" style="color:red;  font-size: 10px"></span> Service Name</label>
            <input type="text" class="form-control" name="additionalName" placeholder="Enter Additional Service Name" required maxlength="40" onkeypress="return validateName(event)">
          </div>
                ...
                if($num > 0){
                    while ($row = mysqli_fetch_array($result)) {
                      ...
                      $id = $row['coverageID'];
                        ...
                        echo '<td>' . $class . '</td>';
                        echo '<td>
                              <input class="checkbox_box_2" type = "checkbox" value = "'.$id.'" name="coverageArray[]">
                              </td>';
                        echo '</tr>';
...
if (isset($_POST['btnCreate'])) {
  require 'parts/php/post/service/additional/btnCreate.php';
}
