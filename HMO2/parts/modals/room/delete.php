...
$result = mysqli_query($con,"SELECT * FROM tblroom");
  ...
  <div class="modal fade modal-danger" id="deleteRoom<?php echo $row['roomID']; ?>" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content" style="margin-top: 10em; margin-left: 3em">
        ...
        <div class="modal-body">
          ...
          <p>Do You Want To Delete <?php echo $row['roomName']?> ?</p>
        </div>
...
if(isset($_POST['btnDelete'])){
  require 'parts/php/post/room/btnDelete.php';
}
