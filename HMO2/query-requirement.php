...
<body class="hold-transition <?php echo $name?> sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      <?php
        require 'parts/styles/query/requirement/sidenav.php';
      ?>
    </aside>
    ...
    <div class="content-wrapper">
      <section name="menu" class="content">
        <?php
          require 'parts/styles/query/requirement/header.php';
          require 'parts/styles/query/requirement/navbar.php';
          require 'parts/datagrid/query/requirement/datagrid.php';
        ?>
      </section>
    </div>
