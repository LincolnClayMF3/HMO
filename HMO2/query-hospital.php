...
<body class="hold-transition <?php echo $name?> sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      <?php
        require 'parts/styles/query/hospital/sidenav.php';
      ?>
    </aside>
    ...
    <div class="content-wrapper">
      <section name="menu" class="content">
        <?php
          require 'parts/styles/query/hospital/header.php';
          require 'parts/styles/query/hospital/navbar.php';
          require 'parts/datagrid/query/hospital/datagrid.php';
        ?>
      </section>
    </div>
