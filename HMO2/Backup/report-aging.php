...
<body class="hold-transition <?php echo $name?> sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      <?php
        require 'parts/styles/report/aging/sidenav.php';
      ?>
    </aside>
    ...
    <div class="content-wrapper">
      <section name="menu" class="content">
        <?php
          require 'parts/styles/report/aging/header.php';
          require 'parts/styles/report/aging/navbar.php';
          require 'parts/datagrid/report/aging/datagrid.php';
        ?>
      </section>
    </div>
