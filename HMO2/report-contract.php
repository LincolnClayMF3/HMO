...
<body class="hold-transition <?php echo $name?> sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      <?php
        require 'parts/styles/report/contract/sidenav.php';
      ?>
    </aside>
    ...
    <div class="content-wrapper">
      <section name="menu" class="content">
        <?php
          require 'parts/styles/report/contract/header.php';
          require 'parts/styles/report/contract/navbar.php';
          require 'parts/datagrid/report/contract/datagrid.php';
        ?>
      </section>
    </div>
