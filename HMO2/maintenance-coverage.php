...
<body class="hold-transition <?php echo $name?> sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      <?php
        require 'parts/styles/coverage/sidenav.php';
      ?>
    </aside>
    ...
    <div class="content-wrapper">
      <section name="menu" class="content">
        <?php
          require 'parts/styles/coverage/header.php';
          require 'parts/styles/coverage/navbar.php';
          require 'parts/datagrid/coverage/datagrid.php';
        ?>
      </section>
    </div>
