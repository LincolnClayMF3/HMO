...
<body class="hold-transition <?php echo $name?> sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      <?php
        require 'parts/styles/report/claims/sidenav.php';
      ?>
    </aside>
    ...
    <div class="content-wrapper">
      <section name="menu" class="content">
        <?php
          require 'parts/styles/report/claims/header.php';
          require 'parts/styles/report/claims/navbar.php';
          require 'parts/datagrid/report/claims/datagrid.php';
        ?>
      </section>
    </div>
