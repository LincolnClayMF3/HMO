...
require 'parts/notification/contract/hospital.php';
...
<body class="hold-transition <?php echo $name?> sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      <?php
        require 'parts/styles/contract/hospital/sidenav.php';
      ?>
    </aside>
    ...
    <div class="content-wrapper">
      <section name="menu" class="content">
        <?php
          require 'parts/styles/contract/hospital/header.php';
          require 'parts/styles/contract/hospital/navbar.php';
          require 'parts/datagrid/contract/hospital/datagrid.php';
        ?>
      </section>
    </div>
