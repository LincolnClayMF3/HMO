...
<body class="hold-transition <?php echo $name?> sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      <?php
        require 'parts/styles/requirement/sidenav.php';
      ?>
    </aside>
    ...
    <div class="content-wrapper">
      <section name="menu" class="content">
        <?php
          require 'parts/styles/requirement/header.php';
          require 'parts/styles/requirement/navbar.php';
          require 'parts/datagrid/requirement/datagrid.php';
        ?>
      </section>
    </div>
