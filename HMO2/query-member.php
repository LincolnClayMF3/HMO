...
<body class="hold-transition <?php echo $name?> sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      <?php
        require 'parts/styles/query/member/sidenav.php';
      ?>
    </aside>
    ...
    <div class="content-wrapper">
      <section name="menu" class="content">
        <?php
          require 'parts/styles/query/member/header.php';
          require 'parts/styles/query/member/navbar.php';
          require 'parts/datagrid/query/member/datagrid.php';
        ?>
      </section>
    </div>
