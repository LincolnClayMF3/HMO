...
<body class="hold-transition <?php echo $name?> sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      <?php
        require 'parts/styles/query/room/sidenav.php';
      ?>
    </aside>
    ...
    <div class="content-wrapper">
      <section name="menu" class="content">
        <?php
          require 'parts/styles/query/room/header.php';
          require 'parts/styles/query/room/navbar.php';
          require 'parts/datagrid/query/room/datagrid.php';
        ?>
      </section>
    </div>
