...
<body class="hold-transition <?php echo $name?> sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      <?php
        require 'parts/styles/query/services/sidenav.php';
      ?>
    </aside>
    ...
    <div class="content-wrapper">
      <section name="menu" class="content">
        <?php
          require 'parts/styles/query/services/header.php';
          require 'parts/styles/query/services/navbar.php';
          require 'parts/datagrid/query/services/datagrid.php';
        ?>
      </section>
    </div>
