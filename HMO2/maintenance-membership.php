...
<body class="hold-transition <?php echo $name?> sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      <?php
        require 'parts/styles/membership/sidenav.php';
      ?>
    </aside>
    ...
    <div class="content-wrapper">
      <section name="menu" class="content">
        <?php
          require 'parts/styles/membership/header.php';
          require 'parts/styles/membership/navbar.php';
          require 'parts/datagrid/membership/datagrid.php';
        ?>
      </section>
    </div>
