...
<body class="hold-transition <?php echo $name?> sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      <?php
        require 'parts/styles/query/category/sidenav.php';
      ?>
    </aside>
    ...
    <div class="content-wrapper">
      <section name="menu" class="content">
        <?php
          require 'parts/styles/query/category/header.php';
          require 'parts/styles/query/category/navbar.php';
          require 'parts/datagrid/query/category/datagrid.php';
        ?>
      </section>
    </div>
