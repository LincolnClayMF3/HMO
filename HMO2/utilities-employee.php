...
<body class="hold-transition <?php echo $name?> sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      <?php
        require 'parts/styles/utilities/employee/sidenav.php';
      ?>
    </aside>
    ...
    <div class="content-wrapper">
      <section name="menu" class="content">
        <?php
          require 'parts/styles/utilities/employee/header.php';
          require 'parts/styles/utilities/employee/navbar.php';
          require 'parts/datagrid/utilities/employee/datagrid.php';
        ?>
      </section>
    </div>
