...
<body class="hold-transition <?php echo $name?> sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      <?php
        require 'parts/styles/service/additional/sidenav.php';
      ?>
    </aside>
    ...
    <div class="content-wrapper">
      <section name="menu" class="content">
        <?php
          require 'parts/styles/service/additional/header.php';
          require 'parts/styles/service/additional/navbar.php';
          require 'parts/datagrid/service/additional/datagrid.php';
        ?>
      </section>
    </div>
