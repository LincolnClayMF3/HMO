...
<body class="hold-transition <?php echo $name?> sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      <?php
        require 'parts/styles/query/coverage/sidenav.php';
      ?>
    </aside>
    ...
    <div class="content-wrapper">
      <section name="menu" class="content">
        <?php
          require 'parts/styles/query/coverage/header.php';
          require 'parts/styles/query/coverage/navbar.php';
          require 'parts/datagrid/query/coverage/datagrid.php';
        ?>
      </section>
    </div>
