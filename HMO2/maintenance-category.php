...
<body class="hold-transition <?php echo $name?> sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      <?php
        require 'parts/styles/category/sidenav.php';
      ?>
    </aside>
    ...
    <div class="content-wrapper">
      <section name="menu" class="content">
        <?php
          require 'parts/styles/category/header.php';
          require 'parts/styles/category/navbar.php';
          require 'parts/datagrid/category/datagrid.php';
        ?>
      </section>
    </div>
