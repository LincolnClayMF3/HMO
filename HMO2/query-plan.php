...
<body class="hold-transition <?php echo $name?> sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      <?php
        require 'parts/styles/query/plan/sidenav.php';
      ?>
    </aside>
    ...
    <div class="content-wrapper">
      <section name="menu" class="content">
        <?php
          require 'parts/styles/query/plan/header.php';
          require 'parts/styles/query/plan/navbar.php';
          require 'parts/datagrid/query/plan/datagrid.php';
        ?>
      </section>
    </div>
