...
<body class="hold-transition <?php echo $name?> sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      <?php
        require 'parts/styles/service/standard/sidenav.php';
      ?>
    </aside>
    ...
    <div class="content-wrapper">
      <section name="menu" class="content">
        <?php
          require 'parts/styles/service/standard/header.php';
          require 'parts/styles/service/standard/navbar.php';
          require 'parts/datagrid/service/standard/datagrid.php';
        ?>
      </section>
    </div>
